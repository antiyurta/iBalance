...
import { EditableTableEndat } from "./editableTableEndat";
...
const TransactionEndatConfig: React.FC<Props> = ({
  selectedDocument,
  onSave,
}) => {
  ...
  const generateCode = async () => {
    ...
    await DocumentService.generateCode({
      movingStatus: MovingStatus.EndatConfig,
    })
      .then((response) => {
        if (response.success) {
...
export default TransactionEndatConfig;
